...
public class MovingPlatform : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision) // chuy?n logic vs tag player tái s? d?ng nhìu l?n thay vì c? tag cái khác
    {
    ...
    // va ch?m chia 2 nhìu va ch?m , vi?t iterfile k? th?a l?i thôi 
